...
public class Next_bigger_number_with_the_same_digits_4kyu { // TODO accepted on codewars.com

    public static void main(String[] args) {

        // int[] array = recSeeker(1234567898765L, 13, new int[13], 0);

        // System.out.println(Arrays.toString(array));

        // System.out.println(nextBiggerNumber(2017));

        System.out.println(nextBiggerNumber(1236987654321L));
        // System.out.println(nextBiggerNumber(2017));
        // System.out.println(nextBiggerNumber(531));
        // System.out.println(nextBiggerNumber(19009));
    }
