...
public class GFG {
    ...
    {
        String[] arr = {"AAC", "ACG", "GAA", "GTT", "TCG"}; // { "catgc", "ctaagt", "gcta", "ttca", "atgcatc" };
        String[] arr98 = {"TATTAA", "GGCGTC", "AAGGCG", "AGTACA", "CGTCCA", "CAAGTA", "TACATA", "TCCAAG", "CATATT", "TTAAGG"};
        String[] arr989 = {"TGGAGT", "ACAATG", "GGCAAC", "AATGGA", "CAACAA", "GAGTGG", "GGCCGG", "GTGGGG", "CCGGCA", "GGGGCC"};
        int len = arr.length;
        ...
        System.out.println("The Shortest Superstring is " +
                findShortestSuperstring(arr98, len)); //TATTAAGGCGTCCAAGTACA

        System.out.println("The Shortest Superstring is " +
                findShortestSuperstring(arr989, len)); // GAGTGGGGCCGGCAACAATG
    }
}
